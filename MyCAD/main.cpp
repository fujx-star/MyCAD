...
#include "Shader.h"
#include "Test.h"
#define MAX_VEC3S 1000      // 向着色器传递的数组的最大长度
...
int main() {
    ...
    Shader lightCubeShader("LightVertex.vert", "LightFragment.frag");

    vector<glm::vec3> vec;
    Test::testRingGenerator(vec);
    float lightingVertices[MAX_VEC3S];
    int i = 0;
    while (i < vec.size() * 3)
    {
        lightingVertices[i] = vec[i / 3].x;
        lightingVertices[i + 1] = vec[i / 3].y;
        lightingVertices[i + 2] = vec[i / 3].z;
        i += 3;
    }
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        lightingShader.setVec3f("light.ambient", glm::vec3(0.7f));
        lightingShader.setVec3f("light.diffuse", glm::vec3(0.5f));
        lightingShader.setVec3f("light.specular", glm::vec3(0.1f));
